...
**Core Value:** **Turn-zero tool relevance without full-catalog exposure.** Every session starts with the right tools visible, not all 168 tools dumped into the model's context window.
<!-- GSD:project-end -->
